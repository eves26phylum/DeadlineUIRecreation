...
const remotes: Instance | undefined = ReplicatedStorage.WaitForChild("remotes", 3);
...
export function processMapInfo(clientTriggered: Player, mapInfo: Folder) {
    ...
    const lobbyCamera: Instance | undefined = cameraPresentationPositions.FindFirstChild("LobbyCamera");
